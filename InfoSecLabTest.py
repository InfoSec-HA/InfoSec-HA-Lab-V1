...
def sc_list():
    if Wlecome == '':
        ...
        f.close()
        print("\033[1;32;80m-----------------------------------------------------------------------------------------------")
        print("\033[1;32;80m--------------------[ Download Recommended Settings ]------------------------")
        print("\033[1;34;80m [+] Enter [10]  [ to Download python and php (Recommended) ]       ")
        print("\033[1;34;80m [+] Enter [11]  [ to Download Depeneded Tools ]       ")
        print("\033[1;32;80m--------------------[ Lab Configuration ]------------------------")
        print("\033[1;34;80m [+] Enter [12]  [ for Lab Configuration (Recommended) ]       ")
        ...
        print("\033[0;34;80m [+] Enter (88) Or anything To [ Exit ]         \n")
    ...
    if x <= 14:
        try:
            ...
            if x == 1:
                ...
                try:
                    print("Step 6: Install php version 7.2 7.3")
                    ...
                    print("\033[0;31;80m  Something want ronge, When php7.2 php7.3 were downloading !!!")
                # Setting php
                try:
                    PHP_V = sys.argv[0]
                    ...
                    print("\033[0;31;80m Something want ronge, When php was Setting !!!")
                ...
                try:
                    ...
                    print("\033[0;31;80m Something want ronge, When python was downloading !!!")
                ...
                try:
                    ...
                    print("[+] Step 2 - Install the Firewall ")
                    os.system("sudo apt install ufw -y")
                    time.sleep(10)
                    sc_list()
                except:
                    print("\033[0;31;80m Something want ronge, When depeneded tools were installing !!!")
                    print("\033[0;32;80m-------------------------------------------------------")
                    sc_list()
                ...
                try:
                    ...
                    print("\033[0;31;80m Something want rong, When Service were turning On !!!")
                ...
                try: 
                    ...
                    # time.sleep(0.5)
                    # Remove zip files
                    os.system("sudo rm -r *.zip ")
                    time.sleep(0.5)
                    #Move Wlecome web test to /var/www/html/index.html
                    print("[*] Moving project assets index.html cover.css InfoSecLabWeb to /var/www/html/")
                    time.sleep(0.5)
                    os.system("sudo mv InfoSecLabWeb /var/www/html/")
                    time.sleep(0.5)
                    os.system("sudo mv assets index.html cover.css /var/www/html/")
                    time.sleep(0.5)
                    print("\033[1;32;80m [+] The project InfoSecLabWeb has been moved successfily to  /var/www/html/")
                    time.sleep(10)
                    sc_list()
                except:
                    print("\033[0;31;80m Something want rong, When labs were configured with files !!!")
...
# f = open('banner.txt', 'r')
# file_contents = f.read()
# print("\033[1;36;40m file_contents")
# f.close()
# def op_list():
...
#     if x <= 7:
#         try:
#             x = int(input("\033[1;32;40m  [*] Enter Your Choise Number : "))
#             if x == 1:
